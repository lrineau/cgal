...
#  define CGAL_assertion_debug(EX, F) (static_cast<void>(0))
...
#  define CGAL_assertion_debug(EX, F)                                        \
  (CGAL::possibly(EX)?(static_cast<void>(0)): ((F)(),::CGAL::assertion_fail( # EX , __FILE__, __LINE__)))
