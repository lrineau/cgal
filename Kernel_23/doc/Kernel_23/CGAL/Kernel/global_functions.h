...
The angle is given in radians and between \f$\left[0,\pi\right] \f$.
...
The angle is given in radians and between \f$\left[-\pi,\pi\right] \f$.
\pre `p,q,r` and `p,q,s` are not collinear.
\warning Before \cgal 4.14 the angle was given in degrees.
*/
template <typename Kernel>
